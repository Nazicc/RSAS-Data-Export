...
:::::::::自定义导出数据 - 可删除、添加、调换位置:::::::::
2:28:系统名称|0:8:责任人|3:8:主机名|4:16:IP地址|8:45:发现风险点描述|9:6:风险分类|10:6:风险等级|11:45:整改建议|13:13:漏洞CVE编号|5:8:漏洞对应端口|6:8:漏洞对应协议|7:8:漏洞对应服务|14:11:漏洞扫描时间|16:11:漏洞发现月份|0:22:是否已备案（由系统管理员填写）|0:16:安全厂家核实备案是否已通过|0:22:备案通过时间|0:22:是否已整改（由系统管理员填写）|1:10:检查厂商|0:15:安全厂家核实是否已整改|0:15:漏洞复核时间|0:8:备注

:::::::::自定义标题颜色:::::::::
A-T:ff0000|P-S:0000ff|U-V:0000ff|W-W:000000
